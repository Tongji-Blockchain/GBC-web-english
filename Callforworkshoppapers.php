...
<div class="flex flex-auto" style="padding-top: 1%">
    ...
    Shenzhen University
        ...
        <br><br>
        <h1>WORKSHOPS</h1>
        <div style=" font-size: 20px;line-height: 1.5;text-align:justify;"> WS-01: <a href="resources/Proposal-GBC-Workshop-BlockchainPolicy.pdf"><span style="color: #4512d2;">Blockchain-And-Policy</span></a></div>
