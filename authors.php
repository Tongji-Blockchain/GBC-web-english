...
<div class="flex flex-auto" style="padding-top: 1%">
	<div style="margin-bottom: 1%;">
		...
		<button style="font-size: larger" onclick="location.href='resources/gbc-cfp-poster.pdf';">Download Call for Papers</button><button style="font-size: larger" onclick="location.href='https://edas.info/newPaper.php?c=32098';">Submit Your Paper Now</button><br><br>
